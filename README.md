## angular-timer — A simple, re-usable, inter-operable timer directive [![Build Status](https://travis-ci.org/june07/angular-timer.png)](https://travis-ci.org/june07/angular-timer)
